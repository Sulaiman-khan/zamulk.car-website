                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="inputrole_name" type="text" name="role_name" value="<?= input_print($role->name) ?>" placeholder="Entry first name...!" disabled>
                                                ...
                                                <?php if ($role_permissions) : ?>
                                                    <?php foreach ($role_permissions as $role_permission) : ?>
                                                        <?php if ($permission->key == $role_permission->key) : ?>
                                                            ...
                                                            <?php $perm_add = ($role_permission->perm_add == $role_permission->assign_perm_add) ? 'checked' : '' ?>
                                                            <?php $perm_view = ($role_permission->perm_view == $role_permission->assign_perm_view) ? 'checked' : '' ?>
                                                            <?php $perm_edit = ($role_permission->perm_edit == $role_permission->assign_perm_edit) ? 'checked' : '' ?>
                                                            <?php $perm_delete = ($role_permission->perm_delete == $role_permission->assign_perm_delete) ? 'checked' : '' ?>
                                                        <?php endif ?>
                                                    <?php endforeach ?>
                                                <?php else : ?>
                                                    <?php $perm_add =  '' ?>
