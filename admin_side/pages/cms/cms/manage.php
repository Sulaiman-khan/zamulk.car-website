                    ...
                    <?php foreach ($query as $row) : ?>
                        <tr>
                            ...
                            <td style="width: 150px;">
                                <?php if ($this->auth->admin_perm_auth('cms', 'edit')) : ?>
                                    <a href="<?= base_url("{$this->uri->segment(1)}/{$this->uri->segment(2)}/edit/{$row->id}") ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                                <?php endif ?>
                                <a href="<?= base_url($row->slug) ?>" class="btn btn-sm btn-info" target="_blank"><i class="fas fa-eye"></i></a>
                                <?php if ($this->auth->admin_perm_auth('cms', 'delete')) : ?>
